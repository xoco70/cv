...
wp_enqueue_script(
'easing', 
get_template_directory_uri().'/vendor/jquery.easing.min.js',
array('jquery'), 
'3', 
true
);
wp_enqueue_script(
'mousewheel', 
get_template_directory_uri().'/vendor/jquery.mousewheel.min.js',
array('jquery'), 
'4', 
true
);
wp_enqueue_script(
'nicescroll', 
get_template_directory_uri().'/vendor/jquery.nicescroll.min.js',
array('jquery'), 
'5', 
true
);
...
wp_enqueue_script(
'nicescroll-plus', 
get_template_directory_uri().'/vendor/jquery.nicescroll.plus.js',
array('jquery'), 
'6', 
true
);
wp_enqueue_script(
'waypoints', 
get_template_directory_uri().'/vendor/waypoints.min.js',
array('jquery'), 
'7', 
true
);
wp_enqueue_script(
'nivo-lightbox', 
get_template_directory_uri().'/vendor/nivo-lightbox/nivo-lightbox.min.js',
array('jquery'), 
'8', 
true
);
wp_enqueue_script(
'bxslider', 
get_template_directory_uri().'/vendor/jquery.bxslider.min.js',
array('jquery'), 
'9', 
true
);
wp_enqueue_script(
'validate', 
get_template_directory_uri().'/vendor/jquery.validate.min.js',
array('jquery'), 
'10', 
true
);
wp_enqueue_script(
'placeholders', 
get_template_directory_uri().'/vendor/placeholders.jquery.min.js',
array('jquery'), 
'11', 
true
);
wp_enqueue_script(
'cross-browser', 
get_template_directory_uri().'/vendor/cross-browser.js',
array('jquery'), 
'12', 
true
);
...
$class_names = ' class="parent '. esc_attr( $class_names ) . '"';
...
/*---------	Theme load animation ---------*/
function vt_custom_js(){
echo '<script>
jQuery(document).ready(function(){
if (jQuery(".vt_animate").hasClass("animated")) {
jQuery(".vt_animate").removeClass("animated");
jQuery(".vt_animate").addClass("animated");
}
else{
jQuery(".vt_animate").addClass("animated");
}
...
function vt_custom_animate_js(){
echo '<script>
jQuery(document).ready(function(){
if (jQuery(".vt_animate").hasClass("animated")) {
jQuery(".vt_animate").removeClass("animated");
}
if (jQuery(".vt_animate").hasClass("fadeInUp")) {
jQuery(".vt_animate").removeClass("fadeInUp");
}
}); 
</script>';
}
...
include ($adminPath . 'custom-fields-portfolio.php');
