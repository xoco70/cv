                    ...
                    menu: [
					   {
                            ...
                            onclick: function() {
                                editor.windowManager.open( {
                                    title: 'Please put your require social link.',
                                    body: [
                                        {
                                            type: 'textbox',
                                            name: 'vt_social_fb_link',
                                            label: 'Put your facebook link.',
                                            value: '#',
                                            minWidth: 450,
                                        },
                                        {
                                            type: 'textbox',
                                            name: 'vt_social_tw_link',
                                            label: 'Put your Twitter link.',
                                            value: '#',
                                            minWidth: 450,
                                        },
                                        {
                                            type: 'textbox',
                                            name: 'vt_social_ld_link',
                                            label: 'Put your linkedin link.',
                                            value: '#',
                                            minWidth: 450,
                                        },
                                        {
                                            type: 'textbox',
                                            name: 'vt_social_ln_link',
                                            label: 'Put your link link.',
                                            value: '#',
                                            minWidth: 450,
                                        },
                                        {
                                            type: 'textbox',
                                            name: 'vt_social_ppo_link',
                                            label: 'Put your paper-plane-o link.',
                                            value: '#',
                                            minWidth: 450,
                                        },
                                        {
                                            type: 'textbox',
                                            name: 'vt_social_bh_link',
                                            label: 'Put your behance link.',
                                            value: '#',
                                            minWidth: 450,
                                        },
                                        {
                                            type: 'textbox',
                                            name: 'vt_social_dr_link',
                                            label: 'Put your dribbble link.',
                                            value: '#',
                                            minWidth: 450,
                                        },
                                        {
                                            type: 'textbox',
                                            name: 'vt_social_ins_link',
                                            label: 'Put your instagram link.',
                                            value: '#',
                                            minWidth: 450,
                                        },
                                        {
                                            type: 'textbox',
                                            name: 'vt_social_gh_link',
                                            label: 'Put your github link.',
                                            value: '#',
                                            minWidth: 450,
                                        },
                                        {
                                            type: 'textbox',
                                            name: 'vt_social_gp_link',
                                            label: 'Put your google-plus link.',
                                            value: '#',
                                            minWidth: 450,
                                        },                                   
                                    ],
                                    onsubmit: function( e ) {
									editor.insertContent( '[vt_social_link vt_social_fb="' + e.data.vt_social_fb_link + '" vt_social_tw="' + e.data.vt_social_tw_link + '" vt_social_ld="' + e.data.vt_social_ld_link + '" vt_social_ln="' + e.data.vt_social_ln_link + '" vt_social_ppo="' + e.data.vt_social_ppo_link + '" vt_social_bh="' + e.data.vt_social_bh_link + '" vt_social_dr="' + e.data.vt_social_dr_link + '" vt_social_ins="' + e.data.vt_social_ins_link + ' " vt_social_gh="' + e.data.vt_social_gh_link + '" vt_social_gp="' + e.data.vt_social_gp_link + '" ][/vt_social_link]');
									}
                                });
                            }
                        },						
